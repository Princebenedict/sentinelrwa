...
import { X, Brain, Zap, Wallet } from "lucide-react";
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1">
                  This triggers a decentralized AI jury evaluation of <strong className="text-white">{projectName}</strong>.
                  Validators independently assess all submitted evidence and reach consensus.
                  This is an on-chain transaction and may take 30 to 90 seconds.
                </p>
              </div>
            </div>
          </div>
