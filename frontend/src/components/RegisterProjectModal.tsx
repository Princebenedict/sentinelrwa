...
import { X, Plus, Upload, Link2, ImageIcon, Sparkles, Wallet } from "lucide-react";
      ...
      <div className="glass-card w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-4">
          ...
          <TextAreaField
            ...
            placeholder="Monthly occupancy above 90%, quarterly maintenance reports filed..."
          />
          ...
          <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-indigo-300 font-medium text-sm">Rated by GenLayer AI Validators</p>
              <p className="text-slate-400 text-xs mt-1">
                The quality rating (shown as stars and a percentage) is produced by decentralized
                AI consensus when you run an evaluation. It cannot be set or edited by hand.
              </p>
            </div>
          </div>
        ...
        <div className="p-6 pt-0 flex gap-3">
          ...
          {address ? (
            ...
            >
              ...
              {connecting ? "Connecting..." : "Connect Wallet to Register"}
            </button>
          )}
        </div>
      </div>
